/*
 ...
 # Copyright (C) 2008 - 2014 magix-cms.com <support@magix-cms.com>
 #
 # OFFICIAL TEAM :
 #
 ...
 */
var MC_convdata = (function ($, undefined) {
    //Fonction Private
    function remove(baseadmin){
        $('.clear-item').on('click',function(event){
            ...
            $('#window-dialog').dialog({
                ...
                height:180,
                width:350,
                title:"Convertir cet élément",
                buttons: {
                    'Convertir': function() {
                        $(this).dialog('close');
                        $.nicenotify({
                            ntype: "ajax",
                            uri: '/'+baseadmin+'/plugins.php?name=convdata',
                            typesend: 'post',
                            noticedata : {module:module,type:type},
